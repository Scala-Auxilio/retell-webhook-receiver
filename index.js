...
function isBusinessHours() {
  ...
  // Mon-Fri (1-5), 16:00 (960) to 21:00 (1260) — covers US East Coast
  // 10:00 am – 3:00 pm EDT (UK calling paused for now; revisit if EU/UK
  // calling resumes — consider country-aware window then).
  return day >= 1 && day <= 5 && totalMinutes >= 960 && totalMinutes < 1260;
}

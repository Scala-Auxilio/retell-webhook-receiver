...
function mapZohoLead(zohoLead) {
  ...
  return {
    ...
    zoho_lead_id: zohoLead.ID || zohoLead.id || zohoLead.Id || zohoLead.lead_id || zohoLead.Lead_Id || zohoLead.LEADID || zohoLead.Lead_ID || Object.values(zohoLead).find(v => /^437076\d{12}$/.test(String(v))) || null,
    edu_level: eduLevel,
